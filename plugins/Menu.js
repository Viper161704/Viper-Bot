...
// send a list message!
    ...
    const rows = [
        ...
        {title: '𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐌𝐄𝐍𝐔', description: "©ʜᴍ\n\n╭═══〘 *ᴅᴡɴʟᴅ ᴍᴇɴᴜ* 〙═══⊷❍\n┃♦️╭────────────────\n┃♦️│➫ *ᴀɴɪᴍᴇ*\n┃♦️│➫ *ᴀᴘᴋᴍᴏᴅ*\n┃♦️│➫ *ɪɢᴛᴠ*\n┃♦️│➫ *ɪᴍɢ*\n┃♦️│➫ *ɪɴѕᴛᴀ*\n┃♦️│➫ *ʀᴀѕʜᴍɪᴋᴀ*\n┃♦️│➫ *ѕᴏɴɢ*\n┃♦️│➫ *ᴠɪᴅᴇᴏ*\n┃♦️│➫ *ᴡᴀʟʟᴘᴀᴘᴇʀ*\n┃♦️╰───────────────\n╰══════════════════⊷\n\n ", rowId:" rowid1"},

        {title: '𝐂𝐎𝐍𝐕𝐄𝐑𝐓𝐄𝐑 𝐌𝐄𝐍𝐔', description: "©ʜᴍ\n\n╭═══〘 *ᴄᴏɴᴠᴇʀᴛᴇʀ* 〙═══⊷❍\n┃♦️╭────────────────\n┃♦️│➫ *ɢɪғ*\n┃♦️│➫ *ᴍᴘ𝟹*\n┃♦️│➫ *ѕᴛɪᴄᴋᴇʀ*\n┃♦️│➫ *ᴍᴘ𝟺*\n┃♦️│➫ *ᴍᴘ𝟺ᴀᴜᴅɪᴏ*\n┃♦️│➫ *ɪᴍᴀɢᴇ ѕᴛɪᴄᴋᴇʀ*\n┃♦️╰───────────────\n╰══════════════════⊷\n\n ", rowId:"rowid2"},

        {title: '𝐒𝐄𝐀𝐑𝐂𝐇 𝐌𝐄𝐍𝐔', description: "©ʜᴍ\n\n╭═══〘 *ѕᴇᴀʀᴄʜ* 〙═══⊷❍\n┃♦️╭────────────────\n┃♦️│➫ *ʏᴛ*\n┃♦️│➫ *ᴡᴇᴀᴛʜᴇʀ*\n┃♦️│➫ *ᴀᴅᴀɴ*\n┃♦️│➫ *ᴄᴏᴠɪᴅ*\n┃♦️│➫ *ɪɢѕᴛᴀᴄᴋ*\n┃♦️│➫ *ʟᴏᴄᴀᴛᴇ*\n┃♦️│➫ *ʟʏʀɪᴄ*\n┃♦️│➫ *ᴍᴏᴠɪᴇ*\n┃♦️│➫ *ɴᴇᴡѕ*\n┃♦️│➫ *ᴘɪɴѕᴛᴀ*\n┃♦️│➫ *ᴘʀᴏғɪɴѕᴛᴀ*\n┃♦️│➫ *ѕʜᴏᴡ*\n┃♦️╰───────────────\n╰══════════════════⊷\n\n ", rowId:" rowid3"},

        {title: '𝐌𝐀𝐊𝐄𝐑 𝐌𝐄𝐍𝐔', description: "©ʜᴍ\n\n╭═══〘 *ᴍᴀᴋᴇʀ* 〙═══⊷❍\n┃♦️╭────────────────\n┃♦️│➫ *ᴀɴɪᴍᴇѕᴀʏ*\n┃♦️│➫ *ᴀᴛᴛᴘ*\n┃♦️│➫ *ᴄᴀʀʙᴏɴ*\n┃♦️│➫ *ᴄʜᴀɴɢᴇѕᴀʏ*\n┃♦️│➫ *ᴅᴇᴇᴘᴀɪ*\n┃♦️│➫ *ᴇғғᴇᴄᴛɪᴍɢ*\n┃♦️│➫ *ғғɪʀᴇ*\n┃♦️│➫ *ʟᴏɢᴏ*\n┃♦️│➫ *ᴍᴇᴍᴇ*\n┃♦️│➫ *ᴍᴍᴘᴀᴄᴋ*\n┃♦️│➫ *ᴍᴏʀᴇᴛxᴛ*\n┃♦️│➫ *ǫʀ*\n┃♦️│➫ *ʀᴇᴍᴏᴠᴇʙɢ*\n┃♦️│➫ *ᴛʙʟᴇɴᴅ*\n┃♦️│➫ *ᴛʀᴜᴍᴘѕᴀʏ*\n┃♦️│➫ *ᴛᴛᴘ*\n┃♦️│➫ *ᴛᴛѕ*\n┃♦️│➫ *ᴜɴᴠᴏɪᴄᴇ*\n┃♦️╰───────────────\n╰══════════════════⊷\n\n ", rowId:" rowid4"},

        {title: '𝐖𝐎𝐑𝐊𝐄𝐑 𝐌𝐄𝐍𝐔', description: "©ʜᴍ\n\n╭═══〘 *ᴡᴏʀᴋᴇʀ* 〙═══⊷❍\n┃♦️╭────────────────\n┃♦️│➫ *ѕѕ*\n┃♦️│➫ *ᴛʀᴛ*\n┃♦️│➫ *ᴛɪɴʏ*\n┃♦️│➫ *ᴡᴀᴍᴇ*\n┃♦️│➫ *ᴏᴄʀ*\n┃♦️│➫ *ᴄᴀʟᴄ*\n┃♦️│➫ *ѕʜᴏʀᴛ*\n┃♦️│➫ *ʀᴅᴍᴏʀᴇ*\n┃♦️│➫ *ʙʀᴅᴍᴏʀᴇ*\n┃♦️│➫ *ǫᴜᴏᴛᴇ*\n┃♦️│➫ *ɪɴѕᴜʟᴛ*\n┃♦️│➫ *ʀᴀɴᴅᴏᴍ*\n┃♦️│➫ *ᴄᴜʀʀᴇɴᴄʏ*\n┃♦️│➫ *ᴄᴏᴍᴘʟɪᴍᴇɴᴛ*\n┃♦️│➫ *ᴅᴇᴛᴇᴄᴛʟᴀɴɢ*\n┃♦️╰───────────────\n╰══════════════════⊷ ", rowId:" rowid5"},

        {title: '𝐎𝐖𝐍𝐄𝐑 𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒', description: "©ʜᴍ\n\n╭════〘 *ᴏᴡɴᴇʀ ᴄᴍɴᴅ* 〙════⊷❍\n┃♦️╭────────────────────\n┃♦️│➫ *ᴊɪᴅ*\n┃♦️│➫ *ʙᴀɴ*\n┃♦️│➫ *ѕᴜᴅᴏ*\n┃♦️│➫ *ᴍᴜᴛᴇ*\n┃♦️│➫ *ѕᴘᴀᴍ*\n┃♦️│➫ *ɪɴᴠɪᴛᴇ*\n┃♦️│➫ *ᴡʜᴏɪѕ*\n┃♦️│➫ *ᴛᴀɢᴀʟʟ*\n┃♦️│➫ *ᴘᴜʙʟɪᴄ*\n┃♦️│➫ *ᴘʟᴜɢɪɴ*\n┃♦️│➫ *ᴅᴇᴍᴏᴛᴇ*\n┃♦️│➫ *ᴘʀɪᴠᴀᴛᴇ*\n┃♦️│➫ *ᴜɴᴍᴜᴛᴇ*\n┃♦️│➫ *ᴘʀᴏᴍᴏᴛᴇ*\n┃♦️│➫ *ᴀɴᴛɪʟɪɴᴋ*  \n┃♦️╰─────────────────\n╰═══════════════════⊷\n\n  ", rowId:" rowid6"}

       ]

       

       const sections = [{title: "© ʜᴍ", rows: rows}]
