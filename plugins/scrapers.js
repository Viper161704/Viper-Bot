...
if (config.WORKTYPE == 'private') {
    ...
    MyPnky.addCommand({pattern: 'sng ?(.*)', fromMe: true, desc: Lang.SONG_DESC}, (async (message, match) => { 
...
/*
    MyPnky.addCommand({pattern: 'sng ?(.*)', fromMe: false, desc: Lang.SONG_DESC}, (async (message, match) => { 
