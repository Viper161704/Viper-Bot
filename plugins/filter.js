...
MyPnk.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
    ...
    if(banned !== undefined) return
    if (!!message.mention && message.mention[0] == '916235199845@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/stickers/hm.webp'), MessageType.sticker, { mimetype: Mimetype.webp, quoted : message.data, ptt: false})
    }
